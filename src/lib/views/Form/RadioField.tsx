...
import { OptionsObject, RadioFieldProps } from '../../types/form';

const renderRadioOptions = (name: string, selected = '', onChange: (e: SyntheticEvent<HTMLInputElement>) => void, options?: OptionsObject): ReactNode => {
	if (!options) {
		return null;
	}
